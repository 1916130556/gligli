...
namespace Web
{
    public partial class Register : System.Web.UI.Page
    {
            ...
            if (this.checkbox.Checked)
            {
                ...
                else if (StrRandom == body)
                {
                    ...
                    UserInfo user = new UserInfo()
                    {
                        ...
                        Account = Email,
                        pwd = pwd,
                        reghitTime = DateTime.Now,
                        state = "zc"
                    };
                    if (UserInfoMananger.InsertUser(user))
                    {
        ...
        {
            if (!UserInfoMananger.AffirmUserEmail(this.txtOneEmail.Text))
            {
        ...
        {
            string userName = txtName.Text;
            if (UserInfoMananger.AffirmUserName(userName))
            {
                args.IsValid = false;
            }
        }
        ...
        {
            string Email = txtOneEmail.Text;
            if (UserInfoMananger.AffirmUserEmail(Email))
            {
                args.IsValid = false;
            }
        }
